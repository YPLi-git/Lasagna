...
void forward_dropout_layer(dropout_layer l, network net,float *input);
...
void forward_avgpool_layer(const avgpool_layer l, network net,float *input);
void backward_avgpool_layer(const avgpool_layer l, network net);

// shortcut layer

layer make_shortcut_layer(int batch, int index, int w, int h, int c, int w2, int h2, int c2);
void forward_shortcut_layer(const layer l, network net,float *input);
...
void forward_yolo_layer(const layer l, network net,float *input);
...
void forward_route_layer(const route_layer l, network net,float *input);
...
void forward_upsample_layer(const layer l, network net,float *input);
...
// void forward_gru_layer(layer l, network state,float *input);
...
// void forward_rnn_layer(layer l, network net,float *input);
